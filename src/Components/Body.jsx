...
const Body = () => {
  return (
    <div className='space-y-4 lg:flex'>
      <div className='flex items-center justify-center flex-1 lg:order-2 lg:justify-end'>
        <img src="./assets/Blue-Shape.svg" alt="1st" className='h-64 -rotate-45 md:h-72 lg:h-[400px]'/>
        <img src="./assets/Pink-Shape.svg" alt="2nd" className='absolute h-64 md:h-72 -rotate-[30deg] lg:h-[400px]'/>
        <img src="./assets/Purple-Shape.svg" alt="3rd" className='absolute h-64 md:h-72 -rotate-[15deg] lg:h-[400px]'/>
